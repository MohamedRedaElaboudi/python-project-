    ...
    <Box sx={{ p: 3, bgcolor: 'background.paper', borderRadius: 2, boxShadow: 1 }}>
      ...
      <Box sx={{ mb: 3 }}>
        <Typography variant="subtitle2" gutterBottom>
          Confiance de la détection: {confidence}%
        </Typography>
        <Tooltip title={`Confiance dans les résultats: ${confidence}%`}>
          <LinearProgress
            variant="determinate"
            value={confidence}
            sx={{
              ...
              '& .MuiLinearProgress-bar': {
                backgroundColor: confidence > 80 ? 'success.main' :
                               confidence > 60 ? 'warning.main' : 'error.main',
              },
            }}
          />
        </Tooltip>
